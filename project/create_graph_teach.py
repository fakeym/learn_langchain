...
class CreateLLMCustomerService(object):
    ...
    def __init__(self):
        self.llm = ChatOpenAI(temperature=0, model="gpt-4o").bind_tools([createGraph()])

        self.messages = [SystemMessage(content="你是一位关于家电行业的智能客服机器人，你可以回答冰箱，空调，电视的问题，请根据用户的问题给出回答，如果用户给出的问题不属于上述三个领域，则给出提示，并重新提问。")]
