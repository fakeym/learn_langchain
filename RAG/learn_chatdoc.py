...
class ChatDoc(object):
    ...
    def __init__(self, filename):
        ...
        self.messages = [SystemMessage(content="你是一位处理文档的工作者，可以根据用户提供的文档内容和上下文内容，用来回答用户的问题。若问题与文档内容不想关，则告诉用户我是一个专注于营地的智能客服，无法回答这个问题，请见谅。"),
    ...
    def chat_with_doc(self, question):
        ...
        self.messages.append(HumanMessage(content=f"{question},文档内容:{contexts}"))
